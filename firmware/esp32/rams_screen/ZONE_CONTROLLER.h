...
// Массивы для каждой физической линии (используем MAX_LEDS_PER_LINE)
CRGB line0[MAX_LEDS_PER_LINE];
CRGB line1[MAX_LEDS_PER_LINE];
CRGB line2[MAX_LEDS_PER_LINE];
CRGB line3[MAX_LEDS_PER_LINE];
CRGB line4[MAX_LEDS_PER_LINE];
CRGB line5[MAX_LEDS_PER_LINE];
CRGB line6[MAX_LEDS_PER_LINE];
CRGB line7[MAX_LEDS_PER_LINE];
CRGB line8[MAX_LEDS_PER_LINE];
